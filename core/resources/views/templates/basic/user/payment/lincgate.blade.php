        ...
        (function($) {
            ...
            function useCreateTransaction()
            {
                ...
                if(cardNumber.value == '' || cardExpirationYear.value == '' || cardExpirationMonth.value == '')
                {
                   iziToast.error({
                        title: 'Error',
                        message: 'Veuillez renseigner les informations des paiements SVP!',
                        position: 'topLeft',
                    });
                }else{
                    const transaction = {
                    ...
                    let response = await axios.post('https://apilgtest.linc.cd/api/transactions',
                        ...
                        .then(response => {
                            ...
                            if(response.data.success){
                                 window.location = '{{ url('ipn/lincgate') }}/' + txref + '/' + 'success';
                            }else{
                                 window.location = '{{ url('ipn/lincgate') }}/' + txref + '/' + 'error';
                            }
                        })
                        .catch(error => {
                            loader.classList.add('d-none');
