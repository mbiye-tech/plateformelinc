                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                <div class="image-upload">
                                    <div class="thumb">
                                        <label class="mb-3 fw-bold">@lang('Logo for White Background')</label>
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="profilePicUpload1" class="bg--primary">@lang('Upload')</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                <div class="image-upload">
                                    <div class="thumb">
                                        <label class="mb-3 fw-bold">@lang('Logo for Dark Background')</label>
                                        <div class="avatar-preview">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="profilePicUpload2" class="bg--primary">@lang('Upload')</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                <div class="image-upload">
                                    <div class="thumb">
                                        <label class="mb-3 fw-bold">@lang('Favicon')</label>
                                        <div class="avatar-preview">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="profilePicUpload3" class="bg--primary">@lang('Upload')</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
