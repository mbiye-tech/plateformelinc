    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <div class="card bg--17 has-link overflow-hidden box--shadow2">
                <a href="{{ route('admin.agents.all') }}" class="item-link"></a>
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-4">
                            <i class="las la-users f-size--56"></i>
                        ...
                        <div class="col-8 text-end">
                            <span class="text-white text--small">@lang('Total Agent')</span>
                            <h2 class="text-white">{{ $widget['total_agent'] }}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card bg-success has-link box--shadow2">
                <a href="{{ route('admin.agents.active') }}" class="item-link"></a>
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-4">
                            <i class="las la-user-check f-size--56"></i>
                        ...
                        <div class="col-8 text-end">
                            <span class="text-white text--small">@lang('Active Agent')</span>
                            <h2 class="text-white">{{ $widget['active_agent'] }}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card bg--5 has-link box--shadow2">
                <a href="{{ route('admin.agents.kyc.unverified') }}" class="item-link"></a>
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-4">
                            <i class="lar la-envelope f-size--56"></i>
                        ...
                        <div class="col-8 text-end">
                            <span class="text-white text--small">@lang('KYC Unverified Agent')</span>
                            <h2 class="text-white">{{ $widget['kycUnverified'] }}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card bg--20 has-link box--shadow2">
                <a href="{{ route('admin.agents.kyc.pending') }}" class="item-link"></a>
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-4">
                            <i class="las la-comment-slash f-size--56"></i>
                        ...
                        <div class="col-8 text-end">
                            <span class="text-white text--small">@lang('KYC Pending Agent')</span>
                            <h2 class="text-white">{{ $widget['kycPending'] }}</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                ...
                <div class="widget-two__content">
                    <h3 class="text-white">{{ $sendMoney['total'] }}</h3>
                    <p class="text-white">@lang('Total Send Money')</p>
                </div>
                <a href="{{ route('admin.send.money.all') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--green">
                ...
                <div class="widget-two__content">
                    <h3 class="text-white">{{ $sendMoney['paid'] }}</h3>
                    <p class="text-white">@lang('Paid')</p>
                </div>
                <a href="{{ route('admin.send.money.paid') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--warning">
                ...
                <div class="widget-two__content">
                    <h3 class="text-white">{{ $sendMoney['payout'] }}</h3>
                    <p class="text-white">@lang('Payout')</p>
                </div>
                <a href="{{ route('admin.send.money.payout') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--5">
                ...
                <div class="widget-two__content">
                    <h3 class="text-white">{{ $sendMoney['refunded'] }}</h3>
                    <p class="text-white">@lang('Refunded')</p>
                </div>
                <a href="{{ route('admin.send.money.refunded') }}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
