...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $widget['active_agent']  = Agent::where('status', 1)->count();
        ...
        // SendMoney Info
        $sendMoney['total']    = SendMoney::whereIn('status', [1, 2])->count();
        $sendMoney['paid']     = SendMoney::paid()->count();
        $sendMoney['payout']   = SendMoney::payout()->count();
        ...
        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'withdrawals', 'sendMoney', 'report', 'depositsMonth', 'withdrawalMonth', 'months', 'trxReport', 'plusTrx', 'minusTrx'));
    }
