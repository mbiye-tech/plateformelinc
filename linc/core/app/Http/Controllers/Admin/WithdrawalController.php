...
class WithdrawalController extends Controller
{
    ...
    public function details($id)
    {
        ...
        $withdrawal = Withdrawal::where('id', $id)->where('status', '!=', 0)->with(['agent', 'method'])->firstOrFail();
    ...
    public function approve(Request $request)
    {
        ...
        $withdraw                 = Withdrawal::where('id', $request->id)->where('status', 2)->with('agent')->firstOrFail();
        $withdraw->status         = 1;
