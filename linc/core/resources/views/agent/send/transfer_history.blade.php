                    ...
                    <div class="text-end">
                        <form action="" method="GET">
                            <div class="search--box">
                                <input type="text" name="search" class="form--control" value="{{ request()->search }}" placeholder="@lang('Transaction No.')" autocomplete="off">
                ...
                <table class="custom--table table">
                    ...
                    <tbody>
                        @forelse ($transfers as $transfer)
                            <tr>
                                <td data-label="@lang('TRANSACTION No.')">{{ $transfer->trx }}</td>
                                ...
                                <td data-label="@lang('Action')">
                                    <button class="btn btn-outline--primary btn-sm approveBtn" data-info="{{ $details }}" data-id="{{ encrypt($transfer->id) }}" data-name="{{ $transfer->recipient->name }}" data-mobile="{{ @$transfer->recipient->dial_code . $transfer->recipient->mobile }}" data-address="{{ $transfer->recipient->address }}" data-country="{{ $transfer->recipient_country }}" data-trx="{{ $transfer->trx }}" data-status="{{ $transfer->status }}">
